    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('keranjang.update', ['keranjang' => $keranjangs]) }}" class="forms-sample"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="exampleInputName1">Quantity:</label>
                            <input type="number" class="form-control" id="exampleInputName1" name="quantity" placeholder="Masukkan quantity" value="{{ old('quantity'). $keranjangs->quantity }}" required />
                        </div>
                        {{-- <div class="form-group">
