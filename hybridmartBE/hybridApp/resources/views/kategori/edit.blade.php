    ...
    <div class="row">
        <div class="col-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form method="POST" action="/kategori/{{ $kategoris->kategori_id }}" class="forms-sample"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama_kategori" name="nama_kategori"
                                value="{{ old('nama_kategori', $kategoris->nama_kategori) }}" placeholder="Masukkan Nama Kategori" />
                        </div>
