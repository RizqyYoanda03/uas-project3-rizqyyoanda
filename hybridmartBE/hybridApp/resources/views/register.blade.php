                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register.simpan') }}" method="post">
                                ...
                                <div class="form-group">
                                    <input type="text" name="username" class="form-control font-weight-bold"z id="exampleInputUsername"
                                        placeholder="Username">
                                </div>
                                <div class="form-group">
                                        <input type="password" name="password" class="form-control font-weight-bold"
                                            id="exampleInputPassword" placeholder="Password">
                                </div>
                                <div class="form-group">
                                    <input type="email" name="email" class="form-control font-weight-bold" id="exampleInputEmail"
